...
function FilteredSegmentBudgetReport() {
    ...
    async function onSubmit(data: FormData) {
        try {
            ...
            const url = `https://www.repository.qtask.net/fpdf/generate/segment_budget_scope_report.php?${queryParams}`;
            ...
            if (response.status === 200) {
                ...
                toast({
                    ...
                    description: 'You have successfully generated the monthly segment budget report.',
                    variant: 'default',
                });
