...
const regionalCausesSchema = z.object({
    customer_id: z.any(),
    startDate: z.any(),
    endDate: z.any(),
...
type FormData = z.infer<typeof regionalCausesSchema >


function RegionalCausesReport() {
    ...
    const form = useForm<FormData>({
        resolver: zodResolver(regionalCausesSchema),
        defaultValues: {
            customer_id: 0,
    ...
    const pdf = process.env.NEXT_PUBLIC_IMAGES + '/fpdf/generate/fault_causes_region.php';
    ...
    async function onSubmit(data: FormData) {
        try {
            ...
            const url = `https://www.repository.qtask.net/fpdf/generate/fault_causes_region.php?${queryParams}`;
            ...
            link.href = blobUrl;
            link.setAttribute('download', 'Regional_Fault_Causes_Report.pdf'); // Set the file name
            ...
            if (response.status === 200) {
                ...
                toast({
                    ...
                    description: 'You have successfully generated regional fault causes analysis report.',
                    variant: 'default',
                });
...
export default RegionalCausesReport;