...
const faultCausesSchema = z.object({
    customer_id: z.any(),
    startDate: z.any(),
    endDate: z.any(),
...
type FormData = z.infer<typeof faultCausesSchema >


function FaultCausesReport() {
    ...
    const form = useForm<FormData>({
        resolver: zodResolver(faultCausesSchema),
        defaultValues: {
            customer_id: 0,
    ...
    async function onSubmit(data: FormData) {
        try {
            ...
            const url = `https://www.repository.qtask.net/fpdf/generate/fault_causes.php?${queryParams}`;
            ...
            link.href = blobUrl;
            link.setAttribute('download', 'Fault_Causes_Report.pdf'); // Set the file name
            ...
            if (response.status === 200) {
                ...
                toast({
                    ...
                    description: 'You have successfully generated fault causes analysis report.',
                    variant: 'default',
                });
...
export default FaultCausesReport;